...
void Position_Marchand(Joueur *J, S_Case P[][Long], int tab[]){
    /**Placement Marchands en fonction de la disponibilité**/
...
void Position_Pirate(Joueur *J, S_Case P[][Long], int tab[]){
    /**Placement Pirates en fonction de la disponibilité**/
...
void Affichage(Joueur *J, S_Case P[][Long], fregate F[], int i){
    /**Affichage+choix des cases de départs**/
    int k, tab[4];
    char name[7];;
    if(i==0){ //Si Marchand
...
void Placement_Bateau(Joueur *J, S_Case P[][Long], fregate F[]){
    ...
    if((*J).M.statut==0){ //Si Marchand Coulé
        int i=0;
        Affichage(J,P,F,i);
    }
    if((*J).P.statut==0){ //Si Pirates Coulé
        int i=1;
        Affichage(J,P,F,i);
    }
}
